class Paper {
  ...
  DisplayHeader() {
    ...
    textStyle(ITALIC);
    text("Beam Element", 350, 150);

    textSize(50);
    text("Under development, ver. 1.4", 350, 250);

    textSize(50);
    text("10/11 - 2024", 1750, 150);
    pop();
  }
  ...
  DisplayText() {
    push();
    textSize(50);
    text("Input Data", this.insertPoint.x + 400, this.insertPoint.y + 392.5);
    text("EigenValue", this.insertPoint.x + 950, this.insertPoint.y + 392.5);
    text("BeamReinforced", this.insertPoint.x + 950, this.insertPoint.y + 300 + 392.5);
    textAlign(CENTER);
    textSize(30);
