...
class ButtonRollor {
  ...
  DisplayButonRollor(mousePos) {
    ...
    text(this.textPro, this.pos1.x, this.pos1.y);
    text(this.textMid, this.pos2.x, this.pos2.y);
    text(this.textPre, this.pos4.x, this.pos4.y);
  ...
  DisplayValueSign() {
    ...
    text(
      ...
      this.signPos.y + 5 + 0.5 * this.buttonHeight
    );
    pop();
  }
