class Paper {
  ...
  DisplayHeader() {
    ...
    textStyle(ITALIC);
    text("Weld calculation", 350, 150);

    textSize(50);
    text("Under development, ver. 1.1", 350, 250);

    textSize(50);
    text("20/09 - 2025", 1750, 150);
    pop();
  }
  ...
  DisplayText() {
    push();
    textSize(50);
    text("Load", this.insertPoint.x + 350, this.insertPoint.y + 392.5);
    text("Geometry", this.insertPoint.x + 350, this.insertPoint.y + 692.5);
    text("calculation", this.insertPoint.x + 350, this.insertPoint.y + 1342.5);
    text("Result", this.insertPoint.x + 350, this.insertPoint.y + 2242.5);
    textAlign(CENTER);
    textSize(30);
