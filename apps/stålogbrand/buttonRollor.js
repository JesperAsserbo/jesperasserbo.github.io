...
class ButtonRollor {
  ...
  DisplayColorID() {
    ...
    if (button_BeamReinforced.state == 1) {
      noStroke();
      fill(0, 0, 255, 150);
      rect(this.pos1.x + 25, this.pos1.y - 12, 15, 15);
    }
    pop();
  }
    ...
    textSize(20);
    text("3", this.pos3.x + 70, this.pos3.y - 20);
    text("3", this.pos4.x + 53, this.pos4.y - 20);
    pop();
  }
  ...
  DisplayDensityUnit() {
    push();
    textSize(20);
    text("3", this.pos3.x + 78, this.pos3.y - 20);
    pop();
  }
  ...
  Display_V_Unit() {
    push();
    textSize(20);
    text("3", this.pos3.x + 62, this.pos3.y - 20);
  ...
  Display_A_Unit() {
    push();
    textSize(20);
    text("2", this.pos3.x + 62, this.pos3.y - 20);
